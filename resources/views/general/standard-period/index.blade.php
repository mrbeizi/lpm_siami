...
@section('title','Data Standard Period')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- AKHIR TOMBOL -->
                            <table class="table table-hover table-responsive" id="table_standard_period">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>Title</th>
                                    ...
                                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title" value="" placeholder="e.g Standar Periode {{date('Y')}}" autofocus />
                                                <span class="text-danger" id="titleErrorMsg" style="font-size: 10px;"></span>
                                            </div>

                                            <label for="is_active" class="form-label">Standar Period State:</label>
                                            <div class="mb-3">
...
<script>
    ...
    // DATATABLE
    $(document).ready(function () {
        var table = $('#table_standard_period').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('data-standard-period.index') }}",
            columns: [
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('data-standard-period.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        ...
                        $('#table_standard_period').DataTable().ajax.reload(null, true);
                        Swal.fire({
                            title: 'Good job!',
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('data-standard-period/' + data_id + '/edit', function (data) {
        ...
        Swal.fire({
            ...
            preConfirm: function() {
                return new Promise(function(resolve) {
                    $.ajax({
                        url: "data-standard-period/" + dataId,
                        type: 'DELETE',
                        data: {id:dataId},
                        dataType: 'json'
    ...
    function PeriodeStatus(id,is_active){
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ Route('switch-standard-period') }}",
    ...
    /* Archive */
    function archiveStd(id,is_archive){
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ Route('archiveStd') }}",
            id: $('.archivestd'+id+'').val(),
