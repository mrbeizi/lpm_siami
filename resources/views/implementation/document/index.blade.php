...
<nav aria-label="breadcrumb mb-0">
    <ol class="breadcrumb breadcrumb-style2">
      ...
      <li class="breadcrumb-item">
        <a href="{{route('data-document.index')}}">@yield('title')</a>
      </li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- AKHIR TOMBOL -->
                            <table class="table table-hover table-responsive" id="table_docs">
                              <thead>
                                <tr>
                                  <th>#</th>
                                  <th>Document Name</th>
                                    ...
                                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="doc_name" name="doc_name" value="" placeholder="e.g SK Auditor" autofocus />
                                                <span class="text-danger" id="docNameErrorMsg" style="font-size: 10px;"></span>
                                            </div>

                                            <div class="mb-3">
                                                <label for="id_period" class="form-label">Period</label>
                                                <select class="form-select" id="id_period" name="id_period" aria-label="Default select example" style="cursor:pointer;">
                                                    <option value="" id="choose_periode">- Choose -</option>
                                                    <option value="1">2024</option>
                                                </select>
                                                <span class="text-danger" id="idPeriodErrorMsg" style="font-size: 10px;"></span>
                                            </div>
...
<script>
    ...
    $(document).ready(function () {
        var table = $('#table_docs').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('data-document.index') }}",
            columns: [
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#table_docs').DataTable().ajax.reload(null, true);
                        Swal.fire({
                            title: 'Good job!',
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('data-document/' + data_id + '/edit', function (data) {
